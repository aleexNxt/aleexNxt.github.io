          ...
          <div className="space-y-6">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-secondary dark:text-gray-400 leading-relaxed">
                ...
                Anwendungsentwicklung bei <span className="text-primary dark:text-white font-medium">Lufthansa Industry Solutions</span> in Frankfurt.
                Im dritten Lehrjahr konzentriere ich mich auf die Entwicklung skalierbarer
                Backend-Systeme und moderner Web-Anwendungen.
              </p>

              <p className="text-lg text-secondary dark:text-gray-400 leading-relaxed">
                Meine Leidenschaft gilt der Backend-Entwicklung mit <span className="text-primary dark:text-white font-medium">Go (Golang)</span>,
                wo ich die Performance und Einfachheit der Sprache schätze. Auf der Frontend-Seite
                setze ich auf <span className="text-primary dark:text-white font-medium">Next.js</span>, um moderne, performante
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-border dark:border-gray-800">
              <div>
                <div className="text-3xl font-bold mb-1">3.</div>
                <div className="text-sm text-secondary dark:text-gray-400">Lehrjahr</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-1">21</div>
                <div className="text-sm text-secondary dark:text-gray-400">Jahre alt</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-1">2</div>
                <div className="text-sm text-secondary dark:text-gray-400">Haupttechnologien</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-1">∞</div>
                <div className="text-sm text-secondary dark:text-gray-400">Lernbereitschaft</div>
              </div>
            </div>
          </div>
        </div>
