    ...
    <div className="prose prose-sm max-w-none">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-sm text-secondary dark:text-gray-400 mt-2 space-y-1">
            <li>
              GitHub:{' '}
              <a
                href="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement"
        ...
        <div className="pt-4 text-xs text-secondary dark:text-gray-400">
