      ...
      >
        <div className="max-w-4xl w-full">
          ...
          >
            ...
            <p className="text-lg text-secondary dark:text-gray-400 mb-12 leading-relaxed">
            ...
            <div className="space-y-4 mb-16">
              {contactLinks.map((link, index) => (
                <a
                  ...
                  className="flex items-center justify-between py-4 border-b border-border dark:border-gray-800 group hover:border-primary dark:hover:border-white transition-colors"
                >
                  <span className="text-sm uppercase tracking-wider text-secondary dark:text-gray-400">
                    {link.label}
                  </span>
                  <span className="text-primary dark:text-white group-hover:text-accent dark:group-hover:text-gray-300 transition-colors font-mono text-sm">
                    {link.value} →
                  </span>
                </a>
              ))}
            ...
            {/* Footer */}
            <div className="pt-12 border-t border-border dark:border-gray-800">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-6">
                  <button
                    ...
                    className="text-sm text-secondary dark:text-gray-400 hover:text-primary dark:hover:text-white transition-colors cursor-pointer"
                  >
                    Impressum
                  </button>
                  <button
